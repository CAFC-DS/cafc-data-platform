...
def _filter_male_iterations(iterations):
    ...
    (decided 2026-05-31), so bulk extracts skip them by default. Pass
    --include-womens (or target one explicitly with --iteration-id) to keep
    them. Already-loaded raw rows stay untouched."""
